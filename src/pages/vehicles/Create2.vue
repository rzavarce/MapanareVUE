      ...
      <q-card-section class="q-pa-none">
        <div class="q-pa-md" style="max-width: 600px">
          ...
          <q-input
            ...
            max="2021"
            lazy-rules
            :rules="[val => val >= 1900 && val <= 2021 || 'Manufacturing Year must be between 1900 and 2021']"
          />
          ...
          <q-input
            ...
            max="150"
            lazy-rules
            :rules="[val => val >= 0 && val <= 150 || 'Fuel Capacity must be between 0 and 150']"
          />
          ...
          <q-input
            ...
            max="1000"
            lazy-rules
            :rules="[val => val >= 0 && val <= 150 || 'Fuel Capacity must be between 0 and 1000']"
          />
          ...
          <q-input
            ...
            max="600"
            lazy-rules
            :rules="[val => val >= 0 && val <= 150 || 'Number of Seats must be between 0 and 600']"
          />
